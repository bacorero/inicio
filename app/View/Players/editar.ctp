<script type="text/javascript">
	...
	$("document").ready(function(){
					...
					var valor_ruta = $("#ruta_foto").val();
					var valor_dir = $('#dir_foto').val();
					//$('#nueva_foto').val(valor_ruta);
					//$('#dir').val(valor_dir);
...
<div class = "container-fluid">
	<div class = "row">
		...
		<img id="foto" src="<?php echo "/inicio/app/webroot/files/player/id_foto/".$player['Player']['dir']."/"."big_".$player['Player']['id_foto']; ?>" /> 


			<?php echo $this->Form->input('id_foto.file.remove',array('type' =>'hidden')); ?> 

			<!-- campo para modificar la foto -->
			<input id="nueva_foto" type="file" name="data[17]" value ="<?php echo "/inicio/app/webroot/files/player/id_foto/".$player['Player']['dir']."/"."big_".$player['Player']['id_foto']; ?>">
			<input id="dir" type="hidden" value ="<?php echo $player['Player']['dir']; ?>" name="data[18]" > 
